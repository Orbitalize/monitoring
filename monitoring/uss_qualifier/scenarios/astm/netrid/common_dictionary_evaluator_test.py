...
def test_evaluate_track():
    ...
    # Value should be between -359 and 359 or the special 361 value
    for valid_value in [0, 0.01, 42, 3.14, 359, 361, -0.01, -42, -3.14, -359]:
        _assert_generic_evaluator_valid_value(*base_args, valid_value=valid_value)

    for invalid_value in [-361, -362, -1000, 360, -360, 377, 1000]:
        _assert_generic_evaluator_invalid_value(
            *base_args, invalid_value=invalid_value, valid_value=42
        )
    ...
    for v1 in [42, 3.14, 100, -100]:
        for valid_delta in [
            ...
            if -359 <= v2 <= 359:  # Ensure value stays valid
                _assert_generic_evaluator_equivalent(*base_args, v1=v1, v2=v2)
        for invalid_delta in [
            1.1,
            2,
    ...
    # Ensure that rounding around the cadrent works
    _assert_generic_evaluator_equivalent(*base_args, v1=-1, v2=359)
    _assert_generic_evaluator_equivalent(*base_args, v1=359, v2=-1)
    _assert_generic_evaluator_equivalent(*base_args, v1=-2, v2=358)
    _assert_generic_evaluator_equivalent(*base_args, v1=358, v2=-2)
...
def test_evaluate_timestamp():
    ...
    _assert_generic_evaluator_equivalent(
        *base_args, v1="2025-01-01T12:00:00Z", v2="2025-01-01T12:00:00.5Z"
    )
    _assert_generic_evaluator_not_equivalent(
